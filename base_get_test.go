...
func TestGetCustomTLSHandshakeTimeout(t *testing.T) {
	if _, err := Get("https://httpbin.org", TLSHandshakeTimeout(10*time.Millisecond)); err == nil {
...
func TestGetProxy(t *testing.T) {
	...
	resp, err := Head(ts.URL, Proxies(map[string]*url.URL{pu.Scheme: pu}))
...
func TestGetSyncInvalidProxyScheme(t *testing.T) {
	resp, err := Get("http://httpbin.org/get", Proxies(map[string]*url.URL{"gopher": nil}))
	if err != nil {
...
func TestGetSession(t *testing.T) {
	...
	resp, err := session.Get("http://httpbin.org/cookies/set", Params(map[string]string{"one": "two"}))
	...
	resp, err = session.Get("http://httpbin.org/cookies/set", Params(map[string]string{"two": "three"}))
	...
	resp, err = session.Get("http://httpbin.org/cookies/set", Params(map[string]string{"three": "four"}))
...
func TestGetInvalidURL(t *testing.T) {
	resp, err := Get("%../dir/", Params(map[string]string{"1": "2"}))
...
func TestGetBasicAuth(t *testing.T) {
	resp, err := Get("http://httpbin.org/get", Auth([]string{"Levi", "Bot"}))
...
func TestGetCustomHeader(t *testing.T) {
	resp, err := Get("http://httpbin.org/get", UserAgent("LeviBot 0.1"), Headers(map[string]string{"X-Wonderful-Header": "1"}))
	// Not the usual JSON so copy and paste from below
...
func TestGetInvalidSSLCertNoVerify(t *testing.T) {
	for _, badSSL := range []string{
		...
		resp, err := Get(badSSL, InsecureSkipVerify(true))
		if err != nil {
			t.Error("Unable to make request", err)
		}
		if resp.Ok != true {
...
func TestGetInvalidSSLCertNoCompression(t *testing.T) {
	resp, err := Get("https://self-signed.badssl.com/", UserAgent("LeviBot 0.1"), DisableCompression(true))
...
func TestGetInvalidSSLCertWithCompression(t *testing.T) {
	resp, err := Get("https://self-signed.badssl.com/", UserAgent("LeviBot 0.1"), DisableCompression(false))
...
func TestGetInvalidSSLCertNoCompressionNoVerify(t *testing.T) {
	resp, err := Get("https://self-signed.badssl.com/", UserAgent("LeviBot 0.1"), InsecureSkipVerify(true), DisableCompression(true))
...
func TestGetInvalidSSLCertWithCompressionNoVerify(t *testing.T) {
	resp, err := Get("https://self-signed.badssl.com/", UserAgent("LeviBot 0.1"), InsecureSkipVerify(true), DisableCompression(false))
...
func TestGetInvalidSSLCert(t *testing.T) {
	resp, err := Get("https://self-signed.badssl.com/", UserAgent("LeviBot 0.1"))
...
func TestGetBasicArgs(t *testing.T) {
	resp, _ := Get("http://httpbin.org/get?Goodbye=World", Params(map[string]string{"Hello": "World"}))
...
func TestGetBasicArgsErr(t *testing.T) {
	ro := Params(map[string]string{"Hello": "World"})
...
func TestGetBasicArgsParams(t *testing.T) {
	ro := Params(map[string]string{"Hello": "World", "Goodbye": "World"})
...
func TestGetString(t *testing.T) {
	...
	if strings.Compare(resp.String(), resp.String()) != 0 {
...
func TestGetRedirectHeaderCopy(t *testing.T) {
	...
	resp, err := Get(srv.URL+"/foo", Headers(map[string]string{"X-Custom": "1"}))
...
func TestUnlimitedRedirects(t *testing.T) {
	...
	resp, err := Get(srv.URL+"/bar", Headers(map[string]string{"X-Custom": "1"}))
...
func TestGetCustomRequestTimeout(t *testing.T) {
	ro := RequestTimeout(2 * time.Nanosecond)
