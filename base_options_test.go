...
func TestOptionsSession(t *testing.T) {
	...
	resp, err := session.Options("http://httpbin.org/cookies/set", Params(map[string]string{"one": "two"}))
	...
	resp, err = session.Options("http://httpbin.org/cookies/set", Params(map[string]string{"two": "three"}))
	...
	resp, err = session.Options("http://httpbin.org/cookies/set", Params(map[string]string{"three": "four"}))
