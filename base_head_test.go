...
func TestHeadSession(t *testing.T) {
	...
	resp, err := session.Head("http://httpbin.org/cookies/set", Params(map[string]string{"one": "two"}))
	...
	resp, err = session.Head("http://httpbin.org/cookies/set", Params(map[string]string{"two": "three"}))
	...
	resp, err = session.Head("http://httpbin.org/cookies/set", Params(map[string]string{"three": "four"}))
